      ...
      >
         ...
         <View style={{ marginTop: 10 }}>
            ...
            <Text style={{ textAlign: "center", marginLeft: 1, marginTop: 2 }}>
               FPT University | Linkedin member
            </Text>
         </View>
         ...
         <Pressable
            ...
            style={{
               marginLeft: "auto",
               marginRight: "auto",
               borderColor: connectionSent || item?.connectionRequests?.includes(userId)
                  ? "gray"
                  : "#0072b1",
               borderWidth: 1,
               borderRadius: 25,
         ...
         >
            <Text
               style={{
                  fontWeight: "600",
                  color: connectionSent || item?.connectionRequests?.includes(userId)
                     ? "gray"
                     : "#0072b1",
               }}
            >
